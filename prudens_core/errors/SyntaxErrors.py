...
class UnmatchedDoubleQuoteError(PrudensSyntaxError):
    ...
    def __init__(self, string: str, *args: object) -> None:
        ...
        super(UnmatchedDoubleQuoteError, self).__init__(
            'Missing closing double quote (") in ' + self.string + ". " + self.__doc__,
            *args,
        )
...
class InvalidArgumentError(PrudensSyntaxError):
    ...
    def __init__(self, message: str, argument: str, *args: object) -> None:
        ...
        super(InvalidArgumentError, self).__init__(
            self.message
            + ". Invalid starting character in argument: "
            + self.argument
            + ". "
            + self.__doc__,
            *args,
...
class InvalidLiteralError(PrudensSyntaxError):
    ...
    def __init__(self, name: str, *args: object) -> None:
        self.name: str = name
        super(InvalidLiteralError, self).__init__(
            "Invalid syntax in literal " + self.name + ". " + self.__doc__, *args
        )
...
class InvalidRuleNameError(PrudensSyntaxError):
    ...
    def __init__(self, rule_string: str, *args: object) -> None:
        ...
        super(InvalidRuleNameError, self).__init__(
            "Invalid rule name in\n" + self.rule_string + "\n" + self.__doc__, *args
        )
...
class MultipleKeywordError(PrudensSyntaxError):
    ...
    def __init__(self, keyword: str, rule_string: str, *args: object) -> None:
        ...
        self.rule_string: str = rule_string
        super(MultipleKeywordError, self).__init__(
            "More than one '"
            + self.keyword
            + "' found in:\n"
            + self.rule_string
...
class KeywordNotFoundError(PrudensSyntaxError):
    ...
    def __init__(self, keyword: str, code_string: str, *args: object) -> None:
        ...
        super(KeywordNotFoundError, self).__init__(
            "Keyword "
            + self.keyword
            + " not found in:\n"
            + self.code_string
...
class MissingDelimiterError(PrudensSyntaxError):
    ...
    def __init__(self, delim: str, *args: object) -> None:
        ...
        super(MissingDelimiterError, self).__init__(
            "Delimiter " + self.delim + " not found. " + self.__doc__, *args
        )
...
class MultipleDelimiterError(PrudensSyntaxError):
    ...
    def __init__(self, delim: str, *args: object) -> None:
        self.delim: str = delim
        super(MultipleDelimiterError, self).__init__(
            "Delimiter " + self.delim + " found more than once." + self.__doc__, *args
        )
...
class MultipleRuleNameError(PrudensSyntaxError):
    ...
    def __init__(self, name: str, r1: str, r2: str, *args: object) -> None:
        ...
        super(MultipleRuleNameError, self).__init__(
            "Rules "
            + self.rule_string_1
            + " and "
            + self.rule_string_2
...
class MalformedPriorityError(PrudensSyntaxError):
    ...
    def __init__(self, priority: str, *args: object) -> None:
        ...
        super(MalformedPriorityError, self).__init__(
            "Malformed priority " + self.priority + ". " + self.__doc__, *args
        )
...
class EmptyRuleBodyError(PrudensSyntaxError):
    ...
    def __init__(self, rule_name: str, *args: object) -> None:
        ...
        super(EmptyRuleBodyError, self).__init__(
            f"Empty rule body for rule {self.rule_name}. " + self.__doc__, *args
        )
...
class ReferenceError(PrudensSyntaxError):
    ...
    def __init__(self, entity_str: str, *args: object) -> None:
        ...
        super(ReferenceError, self).__init__(
            f"Entity {entity_str} referenced but\
                                             it does not exist. "
            + self.__doc__,
            *args,
        )
